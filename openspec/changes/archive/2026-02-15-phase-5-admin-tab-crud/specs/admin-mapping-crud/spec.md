...
### Requirement: Export and Import buttons are visible but non-functional in this phase

The Admin tab SHALL render an "Export Mappings" button and an "Import Mappings" button
at the bottom of the Admin panel. In this phase, both buttons SHALL be present in the
DOM but MUST NOT trigger any action (no-op). Full implementation is deferred to Phase 6.

#### Scenario: Export and Import buttons are visible
